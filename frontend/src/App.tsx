        ...
        <div className="min-h-screen bg-gray-50">
          <Routes>
            ...
            <Route path="/" element={
              ...
              <Route path="admin/restaurants" element={<ProtectedRoute requiredRole="admin"><RestaurantManagement /></ProtectedRoute>} />
              <Route path="admin/orders" element={<ProtectedRoute requiredRole="admin"><OrderManagement /></ProtectedRoute>} />
              <Route path="admin/pos" element={<ProtectedRoute requiredRole="admin"><POSInterface /></ProtectedRoute>} />
            </Route>
