...
const StaffPOS: React.FC = () => {
  ...
  const handleCheckout = (paymentMethod: 'cash' | 'card') => {
    ...
    console.log('Processing staff POS order:', orderData);
          ...
          <div className="p-4 border-t">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:blue-700 text-white font-medium py-3 rounded-lg flex items-center justify-center space-x-2"
              >
