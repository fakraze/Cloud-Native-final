  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Geometric shapes */}
        <div
          className="absolute top-10 right-10 w-12 h-12 border-2 border-blue-300/30 rotate-45 animate-spin"
          style={{ animationDuration: "20s" }}
        ></div>
        <div
          className="absolute bottom-10 left-10 w-8 h-8 border-2 border-purple-300/30 rotate-12 animate-spin"
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <form
          className="glass-card p-8 space-y-6 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1"
        ...
        >
          <div className="space-y-6">
            <div className="group">
              <label
                htmlFor="email"
                className="block text-sm font-bold text-gray-700 mb-3 group-focus-within:text-blue-600 transition-colors duration-200"
              >
                Email address
              </label>
          ...
          <div className="pt-4">
            <button
              ...
              className={`w-full btn-primary relative overflow-hidden group ${
                loginMutation.isPending
                  ? "opacity-75 cursor-not-allowed transform-none shadow-lg"
            ...
            >
              ...
              <span
                className={`relative z-10 flex items-center justify-center font-bold text-lg ${
